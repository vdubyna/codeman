...
run_provenance_records_table = Table(
    ...
    Column("base_profile_id", String(length=64), nullable=True),
    Column("base_profile_name", String(length=255), nullable=True),
    Column("reuse_kind", String(length=32), nullable=False),
    Column("indexing_config_fingerprint", String(length=64), nullable=True),

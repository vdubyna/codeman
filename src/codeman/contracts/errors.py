...
class ErrorCode:
    ...
    BENCHMARK_DATASET_LOAD_FAILED = "benchmark_dataset_load_failed"
    BENCHMARK_DATASET_PATH_NOT_FOUND = "benchmark_dataset_path_not_found"
    BENCHMARK_DATASET_PATH_NOT_FILE = "benchmark_dataset_path_not_file"
    ...
    BENCHMARK_ARTIFACT_MISSING = "benchmark_artifact_missing"
    BENCHMARK_ARTIFACT_CORRUPT = "benchmark_artifact_corrupt"
    BENCHMARK_RUN_INCOMPLETE = "benchmark_run_incomplete"
    BENCHMARK_METRICS_INPUT_UNSUPPORTED = "benchmark_metrics_input_unsupported"
    BENCHMARK_METRICS_CALCULATION_FAILED = "benchmark_metrics_calculation_failed"
    BENCHMARK_REPORT_FAILED = "benchmark_report_failed"
    BENCHMARK_REPORT_RUN_NOT_FOUND = "benchmark_report_run_not_found"
    BENCHMARK_REPORT_RAW_ARTIFACT_MISSING = "benchmark_report_raw_artifact_missing"
    BENCHMARK_REPORT_METRICS_ARTIFACT_MISSING = "benchmark_report_metrics_artifact_missing"
